...
public class CollegeService {
    ...
    public College updateCollege(Long id, College newCollege) {
        return collegeRepository.findById(id).map(existingCollege -> {
            ...
            existingCollege.setEmail(newCollege.getEmail());
            existingCollege.setPhoneNumber(newCollege.getPhoneNumber());
            existingCollege.setEstablishedYear(newCollege.getEstablishedYear());
            existingCollege.setNumberOfDepartments(newCollege.getNumberOfDepartments());
